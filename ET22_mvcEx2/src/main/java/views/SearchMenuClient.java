...
public class SearchMenuClient extends JFrame {
	...
	public SearchMenuClient() {
		...
		lblNewLabel = new JLabel("Introduce el ID del cliente que busques:");
		lblNewLabel.setBounds(156, 11, 223, 23);
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {"ID", "Nombre", "Apellido", "Direccion", "DNI", "Fecha"}
		));
