...
public class SearchMenuCientifico extends JFrame {
	...
	public SearchMenuCientifico() {
		...
		lblNewLabel = new JLabel("Introduce el ID del cientifico que busques:");
		lblNewLabel.setBounds(156, 11, 254, 23);
